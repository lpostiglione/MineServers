...
class PHPMailer {
   ...
   * @access public
   */
  function SetLanguage($langcode = 'de', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      ...
      'empty_message'        => 'E-Mail Inhalt ist leer.',
      'encoding'             => 'Unbekanntes Encoding-Format: ',
      'execute'              => 'Konnte folgenden Befehl nicht ausführen: ',
      'file_access'          => 'Zugriff auf folgende Datei fehlgeschlagen: ',
      'file_open'            => 'Datei Fehler! Konnte folgende Datei nicht öffnen: ',
      'from_failed'          => 'Die folgende Absenderadresse ist nicht korrekt: ',
      'instantiate'          => 'Mail Funktion konnte nicht initialisiert werden.',
      'invalid_address'      => 'E-Mail wird nicht gesendet, die Adresse ist ungültig.',
      'mailer_not_supported' => ' Mailer wird nicht unterstützt.',
      'provide_address'      => 'Bitte geben Sie mindestens eine Empfänger E-Mail Adresse an.',
      'recipients_failed'    => 'SMTP Fehler! Die folgenden Empfänger sind nicht korrekt: ',
      'signing'              => 'Fehler beim Signieren: ',
      'smtp_connect_failed'  => 'Verbindung zu SMTP Server fehlgeschlagen.',
      'smtp_error'           => 'Fehler vom SMTP Server: ',
      'variable_set'         => 'Kann Variable nicht setzen oder zurücksetzen: '
    );

    //Overwrite language-specific strings. This way we'll never have missing translations - no more "language string failed to load"!
    $l = true;
    if ($langcode != 'de') { //There is no Deutsch translation file
